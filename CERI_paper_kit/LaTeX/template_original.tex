...
\title{Factory de mots de passe}
\name{Olivier Fabre$^1$, François Demogue$^2$}
\address{
  $^1$upav2104042, Master Ingénierie Logicielle, Université d'Avignon\\
  $^2$upavxxxxxxx, Master Intelligence Artificielle, Université d'Avignon}
\email{olivier.fabre@alumni.univ-avignon.fr, francois.demogue@alumni.univ-avignon.fr}
